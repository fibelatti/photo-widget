...
class PhotoWidgetSharedPreferences @Inject constructor(
        ...
        sharedPreferences.edit {
            ...
            when (tapAction) {
                ...
                is PhotoWidgetTapAction.AppShortcut -> {
                    ...
                    putString(keys.appShortcutIdKey, tapAction.shortcutId)
                }
                ...
                is PhotoWidgetTapAction.FolderShortcut -> {
                    putString(keys.folderShortcutUriKey, tapAction.folderUri)
                }
        ...
        return PhotoWidgetTapAction.fromSerializedName(name).let { tapAction ->
            when (tapAction) {
                ...
                is PhotoWidgetTapAction.AppShortcut -> tapAction.copy(
                    ...
                    shortcutId = getString(keys.appShortcutIdKey, null),
                )
                ...
                is PhotoWidgetTapAction.FolderShortcut -> tapAction.copy(
                    folderUri = getString(keys.folderShortcutUriKey, null),
                )
    ...
    private fun tapActionKeys(
        ...
        return when (tapActionArea) {
            TapActionArea.LEFT -> TapActionKeys(
                ...
                appShortcutIdKey = "${PreferencePrefix.APP_SHORTCUT_ID_LEFT}$appWidgetId",
                ...
                folderShortcutUriKey = "${PreferencePrefix.FOLDER_SHORTCUT_URI_LEFT}$appWidgetId",
            )
            ...
            TapActionArea.CENTER -> TapActionKeys(
                ...
                appShortcutIdKey = "${PreferencePrefix.APP_SHORTCUT_ID_CENTER}$appWidgetId",
                ...
                folderShortcutUriKey = "${PreferencePrefix.FOLDER_SHORTCUT_URI_CENTER}$appWidgetId",
            )
            ...
            TapActionArea.RIGHT -> TapActionKeys(
                ...
                appShortcutIdKey = "${PreferencePrefix.APP_SHORTCUT_ID_RIGHT}$appWidgetId",
                ...
                folderShortcutUriKey = "${PreferencePrefix.FOLDER_SHORTCUT_URI_RIGHT}$appWidgetId",
            )
        }
    }
    ...
    private enum class PreferencePrefix(val value: String) {
        ...
        APP_SHORTCUT_ID_LEFT(value = "appwidget_app_shortcut_id_left_"),
        APP_SHORTCUT_ID_CENTER(value = "appwidget_app_shortcut_id_"),
        APP_SHORTCUT_ID_RIGHT(value = "appwidget_app_shortcut_id_right_"),
        ...
        FOLDER_SHORTCUT_URI_LEFT(value = "appwidget_folder_shortcut_uri_left_"),
        FOLDER_SHORTCUT_URI_CENTER(value = "appwidget_folder_shortcut_uri_"),
        FOLDER_SHORTCUT_URI_RIGHT(value = "appwidget_folder_shortcut_uri_right_"),
