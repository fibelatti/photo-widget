...
* Exclude the folder view from the Android recents apps menu
...
* New tap action: folder shortcut
...
## [v1.38.2] - 2026-03-04
[v1.38.2]: https://github.com/fibelatti/photo-widget/releases/tag/v1.38.2
...
* Remove additional permissions that were mistakenly added by a dependency

## [v1.38.0] - 2026-02-22
[v1.38.0]: https://github.com/fibelatti/photo-widget/releases/tag/v1.38.0
...
* My Widgets screen now displays widgets with configuration error
...
* New dynamic border color options
* New tap action: app folder

### Changed

* Disable HEIC/HEIF support until the bug introduced with Android 16 is fixed

### Fixed

* Fix vertical offset not working when horizontal offset is also applied
* Prevent photo timer changes from piling up
...
* You can now swipe left and right to switch photos in the full screen viewer
...
* Fix a crop tool crash introduced in version 1.35.0

## [v1.35.0] - 2025-11-28
[v1.35.0]: https://github.com/fibelatti/photo-widget/releases/tag/v1.35.0
